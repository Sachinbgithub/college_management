...
import 'package:college_management/authentication_service.dart';
import 'package:college_management/role_based_home.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _signInWithGoogle() async {
    String? role = await _auth.signInWithGoogle();
    if (role != null) {
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => RoleBasedHome(role: role)));
    }
  }
